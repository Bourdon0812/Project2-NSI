...
class MainInterface:
    ...
    def genButtons(self):
        ...
        getMoyenneByEleveButton: CustomButton = CustomButton(
            ...
            bg="blue",
            fg="white",
            command=lambda: onClick(customButtonsData[eleveMoyenneButtonName]["id"])
        )
        ...
        getMoyenneDevoirButton: CustomButton = CustomButton(
            ...
            bg="blue",
            fg="white",
            command=lambda: onClick(customButtonsData[devoirMoyenneButtonName]["id"])
        )
        ...
        viewMoyennesButton: CustomButton = CustomButton(
            ...
            bg="blue",
            fg="white",
            command=lambda: onClick(customButtonsData[viewAllMoyenneButtonName]["id"])
        )
